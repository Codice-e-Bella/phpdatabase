...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO System_Manufacturer (Manufacturer_Name) VALUES (%s)",
                       GetSQLValueString($_POST['Manufacturer_Name'], "text"));
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    <table align="center">
      <tr valign="baseline">
        ...
        <td><input type="text" name="Manufacturer_Name" value="" size="32" /></td>
      </tr>
      <tr valign="baseline">
