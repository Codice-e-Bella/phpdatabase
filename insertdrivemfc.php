...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO Drive_Manufacturer (Drive_Name) VALUES (%s)",
                       GetSQLValueString($_POST['Drive_Name'], "text"));
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    <table align="center">
      <tr valign="baseline">
        ...
        <td><input type="text" name="Drive_Name" value="" size="32" /></td>
      </tr>
      <tr valign="baseline">
